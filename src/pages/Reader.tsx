...
const Reader: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-2">
          {doc.original_url && (
            <a 
              ...
              className="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-50 dark:bg-zinc-900 text-[10px] font-black uppercase tracking-wider text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-all border border-zinc-100 dark:border-zinc-800"
            >
              <ExternalLinkLineIcon size={14} />
              Original
            </a>
          )}
          <a 
      ...
      <div className="shrink-0 md:hidden p-4 border-t border-zinc-100 dark:border-zinc-900 flex justify-center gap-4 bg-white dark:bg-zinc-950">
          <button 
            onClick={() => navigate('/')}
            className="flex-1 py-3 bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 text-[10px] font-black uppercase tracking-widest rounded-xl active:scale-95 transition-transform"
          >
            Close Reader
          </button>
      </div>
